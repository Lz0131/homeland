        ...
        <div class="row mb-5">
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="property-entry h-100">
                    <a href="{{ route('property-details')}}" class="property-thumbnail">
                    ...
                    <div class="p-4 property-body">
                        ...
                        <h2 class="property-title"><a href="{{ route('property-details')}}">625 S. Berendo St</a></h2>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="property-entry h-100">
                    ...
                    <div class="p-4 property-body">
                        ...
                        <h2 class="property-title"><a href="{{ route('property-details')}}">871 Crenshaw Blvd</a></h2>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="property-entry h-100">
                    ...
                    <div class="p-4 property-body">
                        <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                        <h2 class="property-title"><a href="{{ route('property-details')}}">853 S Lucerne Blvd</a></h2>
